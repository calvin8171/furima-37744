class PurchaseRecordsController < ApplicationController
  ...
  def purchase_record_shipping_info_params
    params.require(:purchase_record_shipping_info).permit(:postal_code, :prefecture_id, :municipalities, :banchi, :tatemono_name, :phone).merge(user_id: current_user.id, item_id: params[:item_id])
  end
end
